    ...
    <LegalPage title="नियम एवं शर्तें" updatedOn="22 सितंबर 2026">
      ...
      <section>
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li><strong>1 साल एक्सेस — ₹349:</strong> पूरे 40 दिन की स्तुति तक 1 साल (365 दिन) की पहुंच — भुगतान की तारीख से 1 साल बाद access समाप्त हो जाता है</li>
      ...
      <section>
        ...
        <p>
          डिजिटल सर्टिफिकेट तभी उपलब्ध होता है जब आप अपने प्लान के अंतर्गत पूरे 40 दिन की साधना सफलतापूर्वक पूरी कर लेते हैं।
        </p>
      </section>
